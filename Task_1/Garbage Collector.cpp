...
// Таким образом при удалении обьекта (уменьшении размера стека, т.е. уменьшении "зоны видимости") из стека, сессия уже не сможет обнаружить обьект в актуальных
...
// В данном примере мы полностью освобождаем стек 
